...
app.use("/public", express.static(path.resolve(__dirname, "..", "frontend", "public"))); // css & images
app.use("/src", express.static(path.resolve(__dirname, "..", "frontend", "src"))); // js & views
...
app.listen(process.env.PORT || 3000, () => console.log('[💥 시작] : Server running...'));
